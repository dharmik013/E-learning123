...
<div class="latest-news-area" id="latest" style=" margin-top: -80px;">
 				<div class="container">
           <h3 style="font-size: 30px; color: white; margin-top: 130px;" align="center"><b><?php echo $_GET['course_name']; ?> Free Video Tutorial</b></h3>
<br>
...
<?php
			...
			<div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-top: 10px;">
 								<div class="latest-news-wrap" style="margin-bottom: 40px;">
 									<div class="news-img">
 										<img src="<?php echo $res['video_image']; ?>" class="img-responsive">
 										<div class="deat">
 											<span><?php echo $res['course_name']; ?> <?php echo ++$abc; ?></span>
 										</div>
 									</div>

 									<div class="news-content" align="center">
 										<br>
 										<a href="java_videos.php?video_id=<?php echo $res['video_id'] ?>&course_name=<?php echo $res['course_name'] ?>" style="font-weight: bold;">watch videos</a>
 									</div>
 								</div>
			</div>
<?php } ?>
