...
<body style="background-image: url('../../images/bgnew.jpg');">
    ...
    <nav>
            ...
            <ul>
                ...
                <li><a href="#home" data-toggle="tab">Courses</a></li>
                <li><a href="#manage_course" data-toggle="tab">Manage Videos</a></li>
            </ul>
        </nav>
    ...
    <div class="tab-content" style="margin-top: -80px;">
        ...
        <div class="tab-pane container active" id="home">
            <div class="latest-news-area" id="latest">
                <div class="container">
                    <h3 style="font-size: 30px; color: white; margin-top: 130px;" align="center"><b>YOUR VIDEO
                            COURSES</b></h3>
                    <br>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-top: 10px;">
                        <div class="latest-news-wrap" style="margin-bottom: 40px;">
                            <div class="news-img">
                                <img src="<?php echo $video_list['image']; ?>" class="img-responsive">
                            </div>

                            <div class="news-content" align="center">
                                <p style="color: black; margin-left: 20px; margin-rigth: 20px; text-align: center;">
                                    <?php echo $video_list['description']; ?>
                                </p>
                                <br>
                                <a href="edit_videos.php?course_name=<?php echo $video_list['course_name']; ?>"
                                    style="font-weight: bold;">Add Videos</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
        ...
        <div class="tab-pane container fade" id="manage_course">
            <div class="col-md-7" style="margin-top: 200px; margin-bottom: 200px; margin-left: 200px;">
                                ...
                                <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                                    ...
                                    <div class="card-body small">
                                        <form action="video_add.php" method="post" enctype="multipart/form-data"
                                            onsubmit="">
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Select video Course Name
                                                    :</label>
