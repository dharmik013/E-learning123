...
<body>
 ...
 <div class="container-fluid" style="margin-top: 50px;" >
      ...
      <div class="col-md-12">   <!--  main body content starts -->
            ...
            <form  method="POST" action="verify/verify_changes.php" class="ml-3" onsubmit="return validation()">
                ...
                <textarea id="editor" name="editor" id="editor" class="ckeditor" placeholder="Enter the content..." style="resize: auto;"></textarea>
